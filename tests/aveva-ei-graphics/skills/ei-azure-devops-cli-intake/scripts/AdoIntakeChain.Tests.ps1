...
BeforeAll {
    ...
    $script:IntakePath = Join-Path $repoRoot 'plugins' 'aveva-ei-graphics' 'skills' 'ei-azure-devops-cli-intake' 'scripts' 'Invoke-EiAdoCliIntake.ps1'
...
Describe 'ei-azure-devops-cli-intake, as copied' -Tag 'Unit' {
    ...
    Context 'the three copied scripts are unedited' {
        ...
        It 'the copied test file points at the renamed plugin folder' {
            ...
            $pluginName = Split-Path -Leaf (Join-Path $script:RepoRoot 'plugins' 'aveva-ei-graphics')
